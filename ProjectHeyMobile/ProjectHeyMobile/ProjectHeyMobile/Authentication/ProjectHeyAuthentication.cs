...
namespace ProjectHeyMobile.Authentication
{
    public class ProjectHeyAuthentication
    {
        ...
        public static string ProjectHeyChatEndpoint = "http://192.168.0.9:7000/projecthey.web/";
        ...
        public static Uri TokenEndpoint = new Uri("https://graph.facebook.com/v2.10/oauth/access_token");
