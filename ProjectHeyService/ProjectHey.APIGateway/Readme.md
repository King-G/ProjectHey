...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *ProjectHey.APIGateway*):

Restore dependencies
```
    cd "ProjectHey.APIGateway"
    dotnet restore
```

Execute unit tests
```
    cd "ProjectHey.APIGateway/test/ProjectHey.APIGateway.Tests"
    dotnet test
```

Deploy application
```
    cd "ProjectHey.APIGateway/src/ProjectHey.APIGateway"
